                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            <div class="w-full md:w-1/2">
                                ...
                                <input type="number" step="any" name="pendapatan_cpo" id="pendapatanCPO" readonly
                                    class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 bg-gray-100">
                            </div>
                            <div class="w-full md:w-1/2">
                                <label class="block text-sm font-medium text-gray-700">Pendapatan PK</label>
                                <input type="number" step="any" name="pendapatan_pk" id="pendapatanPK" readonly
                                    class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 bg-gray-100">
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            <div class="w-full md:w-1/2">
                                ...
                                <input type="number" step="any" name="biaya_produksi" id="biayaProduksi" readonly
                                    class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 bg-gray-100">
                            </div>
                            <div class="w-full md:w-1/2">
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            <div class="w-full md:w-1/2">
                                ...
                                <input type="number" step="any" name="harga_penetapan" id="hargaPenetapan" readonly
                                    class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 bg-gray-100">
                            </div>
                            <div class="w-full md:w-1/2">
